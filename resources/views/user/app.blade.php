...
<head>
    <title>Riky Krisnanda &mdash; Toko Online </title>
    <meta charset="utf-8">
                ...
                <div class="container">
                    <div class="row align-items-center">
                        ...
                        <div class="col-12 mb-3 mb-md-0 col-md-4 order-1 order-md-2 text-center">
                            <div class="site-logo">
                                <a href="index.html" class="js-logo-clone">Toko Online Riky</a>
                            </div>
                        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-lg-6">
                        <div class="block-5 mb-5">
                            <h3 class="footer-heading mb-4">Kotak Info</h3>
                            <ul class="list-unstyled">
                                <li class="address">Jalan sukses menuju dunia akhirat</li>
                                <li class="phone"><a href="tel://23923929210">+62 171220446</a></li>
                                <li class="email">rikykrisnanda@gmail.com</li>
                            </ul>
                        </div>
