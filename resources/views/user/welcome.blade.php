@extends('user.app')
@section('content')
    <div class="site-blocks-cover" style="background-image: url({{ asset('shopper') }}/images/baju.png);" data-aos="fade">
        <div class="container">
            <div class="row align-items-start align-items-md-center justify-content-end">
                <div class="col-md-5 text-center text-md-left pt-5 pt-md-0">
                    <h1 class="mb-2">Cari Kebutuhan Style Kamu Di Sini</h1>
                    <div class="intro-text text-center text-md-left">
                        <p class="mb-4">Fashion Branded terjamin kualitasnya dan tentunya barangnya juga original
                            bukan KW. </p>
                        <p>
            ...
            <div class="row">
                <div class="col-md-6 col-lg-4 d-lg-flex mb-4 mb-lg-0 pl-4" data-aos="fade-up" data-aos-delay="">
                    ...
                    <div class="text">
                        ...
                        <p>Pengiriman bisa ke seluruh wilayah indonesia dengan berbagai macam expedisi</p>
                    </div>
                </div>
